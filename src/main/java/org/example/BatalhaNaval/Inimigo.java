...
class BotUm extends Bot {
    public BotUm(int[][] guerra, int[] ultimo, AtomicInteger pontuacao) {
...
class BotDois extends Bot {
    public BotDois(int[][] guerra, int[] ultimo, AtomicInteger pontuacao) {
        acertar(guerra, ultimo, pontuacao);
    }
...
public class Inimigo {
    ...
    public void Enemy(int dificuldade) {
        switch (dificuldade) {
            case 1 -> new BotUm(guerra, ultimo, pontuacao);
            case 2 -> new BotDois(guerra, ultimo, pontuacao);
